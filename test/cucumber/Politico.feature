...
#CONTROLLER
  ...
  Scenario: Atualizar político
    ...
    When eu tentar atualizar os dados do político  com CPF "01234567890”
  ...
  Scenario: Remover político existente
    ...
    Then o sistema ira mostrar a mensagem politico de CPF “01234567890” removido com sucesso


#GUI
  Scenario: Novo político
    Given que eu estou no menu “Políticos”
    And não existe nenhum político com CPF “102.102.152-15”
    When eu seleciono a opção “Cadastrar”
    And eu tento cadastrar o político com CPF “102.102.152-15” e seleciono “Salvar”
  ...
  Scenario Visualizar político
    ...
    And o político  com o CPF “102.102.152-15” está armazenado no sistema
    When “Guilherme” tenta visualizar o político com o CPF “102.102.152-15”
    Then “Guilherme” conseguirá visualizar as informações

  Scenario: Editar informações de um politico
    Given que o usuário esta na tela de atualizar político visualizando o  político com cpf “01234567890”
    When ao  tentar atualizar os dados do político com cpf “01234567890”
    Then eu recebo a mensagem de confirmação
    And Consigo ver as informações do político cadastrado
